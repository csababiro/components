package com.mobiversal.gradientbutton;
...
public class GradientButton extends AppCompatButton {
    ...
    private void extractViewAttributes(@NonNull Context context, @NonNull AttributeSet attrs) {
        ...
        if (typedArray != null) {
            gradientStartColor = typedArray.getColor(R.styleable.GradientButton_buttonGradientStartColor, defaultColor);
            gradientCenterColor = typedArray.getColor(R.styleable.GradientButton_buttonGradientCenterColor, defaultColor);
            gradientEndColor = typedArray.getColor(R.styleable.GradientButton_buttonGradientEndColor, defaultColor);
            typedArray.recycle();
        } else {
