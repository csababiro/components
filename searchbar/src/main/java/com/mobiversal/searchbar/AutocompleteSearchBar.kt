...
/**
 * Created by Biro Csaba on 03/12/2020.
 */

class AutocompleteSearchBar : ConstraintLayout {
    ...
    private fun inflateView() {
        inflate(R.layout.autocomplete_search_bar, true)
    }
    ...
    fun setEdithTextBackground(editTextBackgroundResId: Int) {
        if (editTextBackgroundResId != 0)
            setBackgroundResource(editTextBackgroundResId);
    }
